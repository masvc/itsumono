                ...
                <?php foreach ($v as $value): ?>
                    <div class="reservation-list">
                        ...
                        <?php if (!empty($value['front_image'])): ?>
                            <img src="../uploads/<?= h($value['detail_uid']); ?>/<?= h($value['front_image']); ?>" alt="フロント画像"><br>
                        <?php else: ?>
                            null<br>
                        <?php endif; ?>
                        サイド画像:<br>
                        <?php if (!empty($value['side_image'])): ?>
                            <img src="../uploads/<?= h($value['detail_uid']); ?>/<?= h($value['side_image']); ?>" alt="サイド画像"><br>
                        <?php else: ?>
                            null<br>
                        <?php endif; ?>
                        バック画像:<br>
                        <?php if (!empty($value['back_image'])): ?>
                            <img src="../uploads/<?= h($value['detail_uid']); ?>/<?= h($value['back_image']); ?>" alt="バック画像"><br>
                        <?php else: ?>
                            null<br>
                        <?php endif; ?>
                        その他画像:<br>
                        <?php if (!empty($value['other_image'])): ?>
                            <img src="../uploads/<?= h($value['detail_uid']); ?>/<?= h($value['other_image']); ?>" alt="その他画像"><br>
                        <?php else: ?>
                            null<br>
                        <?php endif; ?>
